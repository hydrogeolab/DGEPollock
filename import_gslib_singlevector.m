function gslibvector = import_gslib_singlevector(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   GRID2D = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   GRID2D = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   grid2D = importfile('grid2D_iso_30_30.dat',4, 90003);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/07/23 10:43:59
